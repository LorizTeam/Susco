 ...
 */
public class MaterialRTNHDListAction extends LookupDispatchAction {
	...
	public ActionForward search(ActionMapping mapping, ActionForm form,
		...
		throws Exception { //09-10-2012
			...
			//	String serial 	= new String(materialTakeForm.getVendCode().getBytes("ISO8859_1"),"utf-8");
	...
	//	OLD Record	to array list 
				...
				List matTakeHDList = dbMaterialTake.GetMaterialTakeHDList(docTypeCode, docYear, docMonth, "", "", "", "", "","" , "");		
		...
		throws Exception { //12-04-2012
			...
			//	String custName 	=	materialTakeForm.getVendName();
				...
				if (docTypeCode.equals("")) {
					...
					DBMaterialTake dbMaterialTake = new DBMaterialTake();
					List matTakeHDList = dbMaterialTake.GetMaterialTakeSerialHDList(docTypeCode, docYear, docMonth, "", "AC", "", "", "", serial);
					if (matTakeHDList.size() > 0) request.setAttribute("matTakeHDList", matTakeHDList);
	...
	//	New Record	to array list 
					...
					List itemlist = getdtl.GetMaterialTakeRTDTList("", "BRW", "", "", "",serial);
					...
					for (Iterator iter = itemList.iterator(); iter.hasNext();) {
			  			...
			  			custCode = itemForm.getVendCode();
			  			custName = itemForm.getVendName();
			  			x=x+1;
					}
					// end list brrow 
					...
					matTakeHDList.add(new MaterialTakeForm("RT",docTypeCode, docYear, docMonth, docNo, docDate, "", "", docbycode, docbyname,
						"", "", "", "", "", "", "", "", "", "",
						"", "", "", "", "", custCode, custName, remark, "AC"));
					
					materialTakeForm.setDocNo(docNo);
					materialTakeForm.setVendCode(custCode);
					materialTakeForm.setVendName(custName);
					materialTakeForm.setDocTypeCode(docTypeCode);
					materialTakeForm.setDocbycode(docbycode);
					materialTakeForm.setDocbyname(docbyname);
...
//	New Record	to array list 
		...
		//end add old record to list view
			List itemlist = getdtl.GetMaterialRTNDTList(custCode, docTypeCode, docYear, docMonth, docNo,"");
 		
					request.setAttribute("itemlist", itemlist);	
					
				//	List itemlist = getdtl.GetMaterialTakeDTList(custCode, "BRW", "", "", "","");
				//	request.setAttribute("itemlist", itemlist);	
