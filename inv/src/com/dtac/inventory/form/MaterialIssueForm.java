...
public class MaterialIssueForm extends ActionForm {
	...
	private String issuPricePerUnit;
	private String issuAmount;	
	private String issuStatus;
	private String issuCancelStatus;
	...
	public MaterialIssueForm(String docTypeCode, String docYear, String docMonth, String docNo, String docDate, 
		...
		String wahoCode, String wahoName, String emplCode, String emplName, String remark, String periodStatus) { 
		//16-06-2012
		super();
	...
	public MaterialIssueForm(String docTypeCode, String docYear, String docMonth, String docNo, 
		String wahoCode, String itemNo, String matCode, String matName, String refMatCode, String iUnit, 
		String lotNo, String locaCode, String locaName, String issuQty, String issuPricePerUnit,
		String issuAmount, String issuStatus, String issuCancelStatus, String updateDate, String updateByCode, String updateByName, 
		...
		this.issuPricePerUnit = issuPricePerUnit;
		this.issuAmount = issuAmount;
		this.issuStatus = issuStatus;
		this.issuCancelStatus = issuCancelStatus;
	...
	public String getIssuPricePerUnit() {
		return issuPricePerUnit;
	}
	public void setIssuPricePerUnit(String issuPricePerUnit) {
		this.issuPricePerUnit = issuPricePerUnit;
	}
	...
	public String getIssuCancelStatus() {
		return issuCancelStatus;
	}
	public void setIssuCancelStatus(String issuCancelStatus) {
		this.issuCancelStatus = issuCancelStatus;
	}
