...
public class MaterialAlocForm extends ActionForm {
	...
	private String alocStatus;
	private String alocCancelStatus;
	private String alocRemark;
	private String alocDate;
	...
	public MaterialAlocForm(){};	
	public MaterialAlocForm(String docTypeCode, String docYear, String docMonth, String docNo, String docDate, 
		...
		String wahoCode, String wahoName, String emplCode, String emplName, String remark) { //16-06-2012
		super();
	...
	public MaterialAlocForm(String docTypeCode, String docYear, String docMonth, String docNo, 
		String wahoCode, String itemNo, String matCode, String matName, String refMatCode, 
		String lotNo, String locaCode, String locaName, String retuQty, String retuAvalQty,
		String alocStatus, String alocCancelStatus, String alocRemark, String alocDate, String returnDate,
		...
		this.alocStatus = alocStatus;
		this.alocCancelStatus = alocCancelStatus;
		this.alocRemark = alocRemark;
	...
	public String getAlocStatus() {
		return alocStatus;
	}
	public void setAlocStatus(String alocStatus) {
		this.alocStatus = alocStatus;
	}
	...
	public String getAlocRemark() {
		return alocRemark;
	}
	public void setAlocRemark(String alocRemark) {
		this.alocRemark = alocRemark;
	}
	public String getAlocDate() {
		return alocDate;
	}
	public void setAlocDate(String alocDate) {
		this.alocDate = alocDate;
	}
	...
	public String getAlocCancelStatus() {
		return alocCancelStatus;
	}
	public void setAlocCancelStatus(String alocCancelStatus) {
		this.alocCancelStatus = alocCancelStatus;
	}
