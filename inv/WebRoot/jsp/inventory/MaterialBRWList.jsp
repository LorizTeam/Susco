...
<html:html locale="true">
  ...
  <body class="blueback">
	<html:form action="/materialBRWDTList" >
		<fieldset><legend><b class="normal">3.2 Delivery Borrow (ใบยื่มสินค้า) Add Detail</b> </legend>
    ...
    <%=matTakeInfo.getDocTypeCode()%> - <%=matTakeInfo.getDocYear()%> - <%=matTakeInfo.getDocNo()%>
		...
		<tr>						    		
		  ...
		  <tr>
			...
			<font color="black"> 
			&nbsp;&nbsp;Quantity Issue :&nbsp; 
			<html:text style="text-align:right;padding-right:2px;"  property="takequantity" size="3" maxlength="3" onkeyup="calTotalAmout();" value="1"/>
			&nbsp;&nbsp;&nbsp;&nbsp;Amount&nbsp;:&nbsp;
			<html:text style="text-align:right;padding-right:2px;"  property="takeamount" size="15" maxlength="15" readonly="true"/>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;Total Amount&nbsp;:&nbsp;
			<html:text style="text-align:right;padding-right:2px;"  property="taketotalamount" size="15" maxlength="15" readonly="true"/> 
	...
	<table align="center" width="100%" border="1">
		<tr bgcolor="#8E8EA3">	
			<td align="center" class="normal">No</td>
			<td align="center" class="normal">Product Code</td>			
			<td align="center" class="normal">Serial No<br></td>
			<td align="center" class="normal">Customer Code</td>
			<td align="center" class="normal">Product Name</td>			
			<td align="center" class="normal">Quantity Issue<br></td>
			<td align="center" class="normal">Amount</td>
			<td align="center" class="normal">Total Amount</td>
		</tr>
