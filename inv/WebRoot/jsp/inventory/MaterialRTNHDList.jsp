...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"><html:html locale="true">
  ...
  <body class="blueback">
	<html:form action="/materialRTNHDList" >
		<fieldset>
		<legend><b class="normal">3.2 Delivery Return (ใบคืนสินค้า)</b>
		...
		<tr>
			...
			<td class="black">Serial No.&nbsp;:&nbsp;   
 				<html:text property="serial" 	size="15" 	maxlength="15"/>&nbsp;&nbsp;&nbsp;
		...
		<table align="center" width="100%" border="1">
			<tr bgcolor="#8E8EA3">
				...
				<th align="center" class="normal">Document Number</th>
				<th align="center" class="normal">Month</th>
				<th align="center" class="normal">Document Date</th>
				<th align="center" class="normal">Warehouse</th>			
				<th align="center" class="normal">Customer</th>
				<th align="center" class="normal">Employee</th>
			</tr>	
