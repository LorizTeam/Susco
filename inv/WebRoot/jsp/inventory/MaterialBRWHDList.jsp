...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"><html:html locale="true">
  ...
  <body class="blueback">
	<html:form action="/materialBRWHDList" >
		<fieldset>
		<legend><b class="normal">3.2 Delivery Borrow (ใบยื่มสินค้า)</b>
		...
		<tr bgcolor="#8E8EA3">	
			...
			<td align="center" class="normal">Document Number</td>
			<td align="center" class="normal">Month</td>
			<td align="center" class="normal">Document Date</td>
			<td align="center" class="normal">Warehouse</td>			
			<td align="center" class="normal">Customer</td>
			<td align="center" class="normal">Employee</td>
		</tr>
		...
		<tr>			
	   		<td width="10%" class="normal">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="radio" name="radio1" 
			   				...
			   				materialTakeForm.wahoCode.value='<%=matTakeForm.getWahoCode()%>';
			   				materialTakeForm.docNo.value='<%=matTakeForm.getDocNo()%>';	 	
			   				"/>&nbsp;&nbsp;<%=x%>
			   				 
			   				
		   <%	if (matTakeForm.getStatus().equals("BW")) {	%>  
		    ...
		    <td width="15%" class="normal" align="center"><%=matTakeForm.getWahoCode()%>-<%=matTakeForm.getWahoName()%>&nbsp;</td>
