...
<html:html locale="true">
  <head>
	...
	function getVender() {
		var load = window.open('/inv/venderSearchSetup.do?formName=materialRecv','materialRecv',
  ...
  <body class="blueback">
	<html:form action="/materialChangeList" >
		<fieldset>&nbsp; 
		<legend><b class="normal">2.4 Change Order (ใบเปลี่ยนสินค้า)</b>
		...
		<table align="center" width="100%" border="1">
			<tr bgcolor="#8E8EA3">
				...
				<th align="center" class="normal">Receive By</th>
			</tr>	
