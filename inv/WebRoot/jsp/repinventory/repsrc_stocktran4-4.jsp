...
$(function(){  
 ...
 <html:form action="/actsrcrepstocktran44">

	<P><strong>4.4 รายงาน สรุปการ คืนสินค้าสินค้า<br><br>  	  
	  
	 </strong></P> 
 
   
   วันที่ตั้งแต่ (dd/mm/yyyy)<input name="prmfrdate" type="text" id="prmfrdate" value="" size="10"/>  &nbsp;&nbsp;&nbsp; 
   &nbsp;&nbsp;&nbsp;&nbsp; ถึง&nbsp; วันที่(dd/mm/yyyy)  
  <input name="prmtodate" type="text" id="prmtodate" value="" size="10"/> <br>
	<br>	
